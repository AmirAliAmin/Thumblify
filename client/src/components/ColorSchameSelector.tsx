...
function ColorSchameSelector({value, onChange}:{value:string; onChange:(color:string)=>void}) {
  ...
  return (
    <div className="my-3">
        ...
        <p className="text-xs text-zinc-400 mt-2">Selected:{colorSchemes.find((s)=>s.id === value)?.name}</p>
    </div>
  )
}

export default ColorSchameSelector