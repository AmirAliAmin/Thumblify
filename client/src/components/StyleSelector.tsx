...
function StyleSelector({
  ...
  const styleIcon: Record<ThumbnailStyle, ReactNode> = {
  ...
  return (
    <div className="relative space-y-3 my-3 dark">
      ...
      <button
        ...
        className="flex items-center w-full justify-between rounded-md border px-4 py-3 text-left transition bg-white/8 border-white/10 text-zinc-200 hover:bg-white/12"
      >
        ...
        >
          {thumbnailStyles.map((style) => (
            <button
              ...
              className="flex w-full items-start gap-3 px-3 py-3 text-left transition hover:bg-black/30"
            >
