        ...
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 md:gap-4 mt-16 ">
                {featuresData.map((feature: IFeature, index: number) => (
                    ...
                    >
                        <div className="p-4 rounded-xl space-y-4 border border-slate-800 bg-slate-950 max-w-80 w-full">
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    Our AI understands what makes a video go viral and designs thumbnails accordlingly
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <a href="/generate" className="group flex items-center gap-2 mt-4 text-pink-600 hover:text-pink-700 transition">
